...
class GzDeflateEncoderType extends AbstractType
{
    ...
    {
        $builder
            ->add(GzDeflateEncoder::DECODE_MAX_LENGTH, NumberType::class, [
            ...
            ->add(GzDeflateEncoder::ENCODE_ENCODING, ChoiceType::class, [
                'choices' => [
            ...
            ->add(GzDeflateEncoder::ENCODE_LEVEL, NumberType::class, [
            ...
            ->add(GzDeflateEncoder::DATA_PICKER_PATH, TextType::class, [
