...
use Waldhacker\Pseudify\Core\Gui\Form\ProfileDefinition\Column\Encoder\GzDeflateEncoderType;

class GzDeflateEncoder extends AbstractEncoder implements EncoderInterface
{
    final public const string DECODE_MAX_LENGTH = 'gzinflate_max_length';
    final public const string ENCODE_ENCODING = 'gzdeflate_encoding';
    final public const string ENCODE_LEVEL = 'gzdeflate_level';
    ...
    public function decode(mixed $data, array $context = []): mixed
    {
        ...
        try {
            return @gzinflate($data, $maxLength);
        } catch (\ValueError) {
            return false;
        }
    }
    ...
    {
        return GzDeflateEncoderType::class;
    }
}
