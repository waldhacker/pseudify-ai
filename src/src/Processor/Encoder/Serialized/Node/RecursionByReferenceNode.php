 ...
 */
class RecursionByReferenceNode extends Node
{
    /*
     * @api
     */
     ...
     * @api
     */
    public function setContent(int $reference): RecursionByReferenceNode
    {
     ...
     * @api
     */
    public function setValue(int $reference): RecursionByReferenceNode
    {
