...
CREATE USER IF NOT EXISTS 'pseudify'@'%' IDENTIFIED WITH mysql_native_password BY 'P53ud1fy(!)w4ldh4ck3r';

-- https://dev.mysql.com/doc/refman/8.3/en/create-database.html
-- https://dev.mysql.com/doc/refman/8.3/en/charset-charsets.html
