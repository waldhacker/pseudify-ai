-- https://dev.mysql.com/doc/refman/9.1/en/create-user.html
CREATE USER IF NOT EXISTS 'pseudify'@'%' IDENTIFIED WITH caching_sha2_password BY 'P53ud1fy(!)w4ldh4ck3r';

-- https://dev.mysql.com/doc/refman/9.1/en/create-database.html
-- https://dev.mysql.com/doc/refman/9.1/en/charset-charsets.html
